...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM001-008 - Setup Dokumen Jenis Klaim - Setup Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKLM001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Dokumen_Jenis_Klaim()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Dokumen_Jenis_Klaim()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Dokumen_Jenis_Klaim()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Dokumen_Jenis_Klaim()
End If
