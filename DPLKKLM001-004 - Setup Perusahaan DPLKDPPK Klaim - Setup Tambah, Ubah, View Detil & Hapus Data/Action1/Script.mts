...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM001-004 - Setup Perusahaan DPLKDPPK Klaim - Setup Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKLM001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Perusahaan_DPLK_DPPK()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Perusahaan_DPLK_DPPK()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Perusahaan_DPLK_DPPK()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Perusahaan_DPLK_DPPK()
End If
...
Call spReportSave()
'	msgbox "Check"
'	msgbox DataTable.Value("COMMAND_LOG","DPLKDBConfig")
'	
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathDPLK & "DPLK_Klaim_Setup.qfl")
