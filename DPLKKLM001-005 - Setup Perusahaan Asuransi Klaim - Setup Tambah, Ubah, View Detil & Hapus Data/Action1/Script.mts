...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM001-005 - Setup Perusahaan Asuransi Klaim - Setup Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKLM001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Perusahaan_Asuransi()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Perusahaan_Asuransi()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Perusahaan_Asuransi()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Perusahaan_Asuransi()
End If
