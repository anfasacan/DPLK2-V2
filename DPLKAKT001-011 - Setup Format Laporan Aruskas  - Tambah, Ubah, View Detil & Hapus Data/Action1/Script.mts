...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT001-011 - Setup Format Laporan Aruskas  - Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKAKT001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Akuntansi_Setup_Format_Laporan_Aruskas()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Akuntansi_Setup_Format_Laporan_Aruskas()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Akuntansi_Setup_Format_Laporan_Aruskas()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Akuntansi_Setup_Format_Laporan_Aruskas()
End If
