...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKADM004-001 - Log Audit Trail - View Detil Data.xlsx", "DPLKADM004")
Call spGetDatatable()
...
Call AC_GoTo_Menu()
wait 10
Call View_Laporan_Administration_Log_Audit_Trail()
Call DA_Logout("0")
Call spReportSave()
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathDPLK & "DPLK_Administration_Laporan.qfl")
	...
	Call RepositoriesCollection.Add(LibRepo & "RP_Administration_Laporan.tsr")
