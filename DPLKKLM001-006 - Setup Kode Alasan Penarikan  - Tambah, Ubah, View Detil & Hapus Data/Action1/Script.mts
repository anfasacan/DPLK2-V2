...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM001-006 - Setup Kode Alasan Penarikan Klaim - Setup Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKLM001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Kode_Alasan_Penarikan()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Kode_Alasan_Penarikan()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Kode_Alasan_Penarikan()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Kode_Alasan_Penarikan()
End If
