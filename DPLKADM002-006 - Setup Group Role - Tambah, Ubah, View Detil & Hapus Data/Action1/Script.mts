...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKADM002-006 - Setup Group Role - Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKADM002")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Administration_Setup_Group_Role()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Administration_Setup_Group_Role()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Administration_Setup_Group_Role()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Administration_Setup_Group_Role()
End If
