...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM002-071 - Klaim - Laporan - Cetakan data pencairan yang gagal atau belum terselesaikan di cabang dan dapat di download.xlsx", "DPLKKLM002")
Call spGetDatatable()
...
Call Cetak_Laporan_Rekap_Register()
Call DA_Logout("0")
