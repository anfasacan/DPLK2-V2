...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT001-003 - Setup Akun Mapping - Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKAKT001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Akuntansi_Setup_Akun_Mapping()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Akuntansi_Setup_Akun_Mapping()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Akuntansi_Setup_Akun_Mapping()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Akuntansi_Setup_Akun_Mapping()
End If
