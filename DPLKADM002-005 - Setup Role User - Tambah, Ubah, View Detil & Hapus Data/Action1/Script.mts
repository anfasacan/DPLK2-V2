...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKADM002-005 - Setup Role User - Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKADM002")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Ubah_Setup_Administration_Setup_Role_User
ElseIf Iteration = 2 Then	
	Call Lihat_Setup_Administration_Setup_Role_User
ElseIf Iteration = 3 Then
	Call Hapus_Setup_Administration_Setup_Role_User
End If
