...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM001-009 - Setup Jenis Laporan Klaim - Setup Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKLM001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Jenis_Laporan()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Jenis_Laporan()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Jenis_Laporan()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Jenis_Laporan()
End If
