...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT006-023 - Akuntansi - Transaksi -Cek Jurnal 000004896 PT TERMINAL PETIKEMAS SURABAYA.xlsx", "DPLKAKT006")
Call spGetDatatable()
...
ElseIf Iteration = 3 Then
	...
	Call Lihat_Entry_Jurnal_Transaksi()
	Call Search_Setup_Bank_By_Entry_Jurnal_Transaksi()
