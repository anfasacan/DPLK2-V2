...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT001-013 - Setup Format Laporan Perubahan Aset Netto  - Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKAKT001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Akuntansi_Setup_Format_Laporan_Perubahan_Aset_Netto()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Akuntansi_Setup_Format_Laporan_Perubahan_Aset_Netto()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Akuntansi_Setup_Format_Laporan_Perubahan_Aset_Netto()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Akuntansi_Setup_Format_Laporan_Perubahan_Aset_Netto()
End If
