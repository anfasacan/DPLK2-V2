...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKADM002-003 - Setup User - Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKADM002")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Administration_Setup_User()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Administration_Setup_User()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Administration_Setup_User()
End If
