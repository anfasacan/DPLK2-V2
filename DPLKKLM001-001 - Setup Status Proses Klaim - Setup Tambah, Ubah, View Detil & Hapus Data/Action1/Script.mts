...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM001-001 - Setup Status Proses Klaim - Setup Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKLM001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Klaim_Status_Proses()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Klaim_Status_Proses()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Klaim_Status_Proses()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Klaim_Status_Proses()
End If
