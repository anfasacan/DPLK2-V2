...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKADM003-030 - Setup Kurs - Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKADM003")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Administration_Setup_Kurs()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Administration_Setup_Kurs()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Administration_Setup_Kurs()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Administration_Setup_Kurs()
End If
