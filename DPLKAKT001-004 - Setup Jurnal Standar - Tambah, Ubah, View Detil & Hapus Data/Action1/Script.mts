...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT001-004 - Setup Jurnal Standar - Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKAKT001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Akuntansi_Setup_Jurnal_Standar()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Akuntansi_Setup_Jurnal_Standar()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Akuntansi_Setup_Jurnal_Standar()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Akuntansi_Setup_Jurnal_Standar()
End If
