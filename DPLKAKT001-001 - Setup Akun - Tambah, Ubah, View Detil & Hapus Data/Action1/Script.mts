...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT001-001 - Setup Akun - Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKAKT001")
Call spGetDatatable()
...
If Iteration = 1 Then
	Call Tambah_Setup_Akuntansi_Setup_Akun()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Akuntansi_Setup_Akun()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Akuntansi_Setup_Akun()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Akuntansi_Setup_Akun()
End If
