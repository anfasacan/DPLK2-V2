...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT001-006 - Setup Bank BI - Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKAKT001")
Call spGetDatatable()
...
Call AC_GoTo_Menu()
If Iteration = 1 Then
	Call Tambah_Setup_Akuntansi_Setup_Bank_BI()
ElseIf Iteration = 2 Then	
	Call Ubah_Setup_Akuntansi_Setup_Bank_BI()
ElseIf Iteration = 3 Then
	Call Lihat_Setup_Akuntansi_Setup_Bank_BI()
ElseIf Iteration = 4 Then
	Call Hapus_Setup_Akuntansi_Setup_Bank_BI()
End If
